...
# Compilar el informe (genera docs/informe-final/main.pdf, 100 páginas)
make pdf
...
El informe se compila desde el directorio `docs/informe-final/` (100 páginas),
...
Documento académico completo — **100 páginas** con anexos y capturas CI/Render: [`docs/informe-final.pdf`](docs/informe-final.pdf) · Fuente LaTeX: [`docs/informe-final/main.tex`](docs/informe-final/main.tex) + `refs.bib` · Wrapper para Listing 1 p.17: [`docs/informe-final.tex`](docs/informe-final.tex).
