...
\begin{enumerate}
  ...
  \item \textbf{Evidencia de calidad:} 298 pruebas JUnit 5 con JaCoCo 95,52\% instrucciones / 88,38\% ramas / 95,97\% líneas (reporte completo), análisis estático SpotBugs 4.8.6 (0 hallazgos), escaneo OWASP ZAP baseline (0 High / 2 Med) y pruebas de carga k6 (3 corridas, media 23,01\,ms, p95 máx 173,13\,ms).
