...
\begin{enumerate}
  ...
  \item Aplicar la prueba de System Usability Scale (SUS) con un mínimo de 10 participantes para evaluar la usabilidad percibida del sistema.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{Evidencia de calidad:} 299 pruebas JUnit 5 con JaCoCo 95,67\% instrucciones / 88,38\% ramas / 96,19\% líneas (reporte completo), análisis estático SpotBugs 4.8.6 (0 hallazgos), escaneo OWASP ZAP baseline (0 High / 2 Med) y pruebas de carga k6 (3 corridas, media 23,01\,ms, p95 máx 173,13\,ms).
