...
\begin{itemize}
  ...
  \item \textbf{Usabilidad:} SUS 63,0 (IC\,95\,\% [53,07; 72,93], n=10), clasificado como
        \emph{bueno}; se mantiene por debajo del umbral de 70, en zona marginal por la
        amplitud del intervalo de confianza.
  \item \textbf{Cobertura:} reporte completo 95,52\,\% instrucciones / 88,38\,\% ramas / 95,97\,\% líneas con JaCoCo sobre 298 pruebas JUnit, superando el umbral LINE 0,70 / BRANCH 0,50.
