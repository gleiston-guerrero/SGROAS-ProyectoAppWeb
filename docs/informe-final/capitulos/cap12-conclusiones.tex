...
\begin{itemize}
  \item \textbf{Rendimiento:} p95 máximo de 173.13\,ms (umbral 200\,ms) y 0\,\% de
        errores en el entorno local sin throttling (serie K1--K3); media de medias
        de 23.01\,ms con IC\,95\,\% [$-$7.88; 53.91]\,ms. El efecto de la caché de
        aplicación (K9, K10--K14) es real en la corrida piloto pero no alcanza
        significancia estadística con $n=5$ (\S\ref{sec:perf}).
