...
\begin{itemize}
  ...
  \item \textbf{Usabilidad:} SUS 68,5 (IC\,95\,\% [60,76; 76,24], n=15), clasificado como
        \emph{bueno}; supera el umbral de 70 pero se mantiene en zona marginal por la
        amplitud del intervalo de confianza.
  \item \textbf{Cobertura:} reporte completo 95,49\,\% instrucciones / 88,38\,\% ramas / 95,94\,\% líneas con JaCoCo sobre 293 pruebas JUnit, superando el umbral LINE 0,70 / BRANCH 0,50.
