...
ejecución de \texttt{./mvnw verify} con 298 pruebas JUnit 5.

\textbf{Datos crudos:} \texttt{docs/mediciones/jacoco/jacoco.csv} y reporte HTML
(versionado en \texttt{dataset/jacoco}).

\textbf{Resultado (reporte completo):} instrucciones 95.52\,\%,
ramas 88.38\,\% y líneas 95.97\,\%, con 0 fallos. Se supera el umbral del proyecto
...
C.4 Cobertura & líneas $\ge$ 70\,\% & 95.97\,\% & Sí \\
