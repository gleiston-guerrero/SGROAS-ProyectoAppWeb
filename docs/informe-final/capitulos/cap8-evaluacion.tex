...
significativa entre frío y caliente, y el tamaño del efecto es pequeño,
incluso con signo variable entre corridas (K11 y K14 muestran la
caliente más lenta que la fría). Esto es consistente con el diagnóstico
ya declarado más arriba: en el plan gratuito de Render la variabilidad
de red/CPU domina sobre cualquier ahorro de consultar Redis en vez de
PostgreSQL, al punto de que con $n=5$ no se puede distinguir el efecto
de caché del ruido de red. La única corrida que sí mostró una diferencia
