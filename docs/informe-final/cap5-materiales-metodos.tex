...
El diseño empírico se formaliza con el enfoque GQM de Basili et al.~\cite{basili1994}. La meta, preguntas y métricas se resumen en Table~\ref{tab:gqm}.
...
Table~\ref{tab:sus-demografia} cruza demografía (edad, sexo, experiencia web) con el puntaje SUS por participante; los datos se versionan en \texttt{dataset/sus/sus-raw.csv} y \texttt{P01.json..P10.json}, y los 10 códigos se corresponden 1:1 con el capítulo de resultados.
...
\begin{enumerate}
  \item Se ejecuta \texttt{./mvnw clean verify} que ejecuta las 299 pruebas JUnit 5 y genera el reporte JaCoCo.
