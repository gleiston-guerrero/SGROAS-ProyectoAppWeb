...
\begin{itemize}
  \item \textbf{Cobertura de pruebas (JaCoCo):} reporte completo 95,67\% instrucciones / 88,38\% ramas / 96,19\% líneas (datos reproducibles en \texttt{dataset/jacoco/jacoco.csv}).
  \item \textbf{Número de pruebas:} 299 pruebas JUnit 5 (unitarias e de integración).
