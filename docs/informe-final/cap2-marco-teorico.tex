...
\begin{itemize}
  ...
  \item \textbf{Capa de lógica de negocio:} Spring Boot 3.5.x con Java 21 LTS, que implementa los controladores, servicios y repositorios.
...
\subsection{Spring Boot 3.5.x con Java 21 LTS}
\label{sec:spring}

Spring Boot \cite{springboot} es un framework que simplifica la creación de aplicaciones basadas en Spring. SGROAS utiliza Spring Boot 3.5.x con Java 21 LTS (Long Term Support), aprovechando:
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Usabilidad:} SUS de 63,0 (DT 13,88, n=10).
\end{itemize}
...
\begin{itemize}
  \item \textbf{Cobertura de pruebas (JaCoCo):} reporte completo 95,52\% instrucciones / 88,38\% ramas / 95,97\% líneas (datos reproducibles en \texttt{dataset/jacoco/jacoco.csv}).
  \item \textbf{Número de pruebas:} 298 pruebas JUnit 5 (unitarias e de integración).
