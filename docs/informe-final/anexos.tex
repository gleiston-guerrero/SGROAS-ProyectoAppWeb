...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figuras/fig-ci-actions-3-green.png}
  \caption{CI pipeline (GitHub Actions). The seven most recent runs visible (\#246--\#252) all completed successfully and all carry English commit messages; the three at the top are \#252 (commit \texttt{bb5b87c}, branch \texttt{main}), \#251 and \#250 (commit \texttt{14f7e39}, tag \texttt{v1.1.0} and branch \texttt{main}). Unedited screenshot taken on 2026-09-19.}
  \label{fig:ci-3-green}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{figuras/fig-render-deploy-succeeded-live.png}
  \caption{Deploy detail view on Render for commit \texttt{bb5b87c}: status \texttt{Deploy succeeded | Live}, duration 3m54s, deployed 2026-09-19 at 22:05:54 GMT-5. Unedited screenshot taken on 2026-09-19.}
...
OBS-09 & 3 / P3 Cobertura & 299 tests JUnit 5; JaCoCo 95,67\% instrucciones / 88,38\% ramas / 96,19\% líneas (\texttt{5f3b472}, reconciliado \texttt{17f484a}) \\
OBS-10 & 3 / D3 SUS & SUS n=10 (P01..P10) con consentimiento en \texttt{docs/etica/}, media 63,0 IC95\% [53,1;72,9]; P11--P15 excluidos por falta de respaldo documental (\texttt{ver dataset/sus/PARTICIPANTES-NO-INCLUIDOS.md}) \\
